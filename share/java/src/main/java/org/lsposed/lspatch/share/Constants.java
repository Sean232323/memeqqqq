...
public class Constants {
    ...
    final static public String CONFIG_ASSET_PATH = "assets/memeq/config.json";
    final static public String LOADER_DEX_ASSET_PATH = "assets/memeq/loader.dex";
    final static public String META_LOADER_DEX_ASSET_PATH = "assets/memeq/metaloader.dex";
    final static public String ORIGINAL_APK_ASSET_PATH = "assets/memeq/origin.apk";
    final static public String EMBEDDED_MODULES_ASSET_PATH = "assets/memeq/modules/";
